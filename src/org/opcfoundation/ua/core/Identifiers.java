...
public class Identifiers {
    ...
    public static final NodeId RegisteredServer2 = init(12192);
    ...
    public static final NodeId ServerConfigurationType_Restart = init(12619);
    public static final NodeId ServerConfigurationType_TrustList_AddCertificate = init(12612);
    public static final NodeId ServerConfigurationType_TrustList_Close = init(12594);
    public static final NodeId ServerConfigurationType_TrustList_CloseAndUpdate = init(12610);
    public static final NodeId ServerConfigurationType_TrustList_GetPosition = init(12601);
    public static final NodeId ServerConfigurationType_TrustList_Open = init(12591);
    public static final NodeId ServerConfigurationType_TrustList_OpenWithMasks = init(12607);
    public static final NodeId ServerConfigurationType_TrustList_Read = init(12596);
    public static final NodeId ServerConfigurationType_TrustList_RemoveCertificate = init(12614);
    public static final NodeId ServerConfigurationType_TrustList_SetPosition = init(12604);
    public static final NodeId ServerConfigurationType_TrustList_Write = init(12599);
    public static final NodeId ServerConfigurationType_UpdateCertificate = init(12616);
    public static final NodeId ServerConfiguration_Restart = init(12675);
    public static final NodeId ServerConfiguration_TrustList_AddCertificate = init(12668);
    public static final NodeId ServerConfiguration_TrustList_Close = init(12650);
    public static final NodeId ServerConfiguration_TrustList_CloseAndUpdate = init(12666);
    public static final NodeId ServerConfiguration_TrustList_GetPosition = init(12657);
    public static final NodeId ServerConfiguration_TrustList_Open = init(12647);
    public static final NodeId ServerConfiguration_TrustList_OpenWithMasks = init(12663);
    public static final NodeId ServerConfiguration_TrustList_Read = init(12652);
    public static final NodeId ServerConfiguration_TrustList_RemoveCertificate = init(12670);
    public static final NodeId ServerConfiguration_TrustList_SetPosition = init(12660);
    public static final NodeId ServerConfiguration_TrustList_Write = init(12655);
    public static final NodeId ServerConfiguration_UpdateCertificate = init(12672);
    ...
    public static final NodeId RegisteredServer2_Encoding_DefaultBinary = init(12210);
    public static final NodeId RegisteredServer2_Encoding_DefaultXml = init(12198);
    ...
    public static final NodeId ServerConfigurationType_TrustList = init(12586);
    public static final NodeId ServerConfiguration_TrustList = init(12642);
    ...
    public static final NodeId AuthorityType = init(12555);
    ...
    public static final NodeId Rsa2084ApplicationCertificateType = init(12560);
    public static final NodeId RsaBasicApplicationCertificateType = init(12559);
    ...
    public static final NodeId OpcUa_BinarySchema_RegisteredServer2 = init(12216);
    public static final NodeId OpcUa_BinarySchema_RegisteredServer2_DataTypeVersion = init(12217);
    public static final NodeId OpcUa_BinarySchema_RegisteredServer2_DictionaryFragment = init(12218);
    ...
    public static final NodeId OpcUa_XmlSchema_RegisteredServer2 = init(12204);
    public static final NodeId OpcUa_XmlSchema_RegisteredServer2_DataTypeVersion = init(12205);
    public static final NodeId OpcUa_XmlSchema_RegisteredServer2_DictionaryFragment = init(12206);
    ...
    public static final NodeId ServerConfigurationType_SupportedCertificateTypes = init(12709);
    public static final NodeId ServerConfigurationType_SupportedPrivateKeyFormats = init(12583);
    public static final NodeId ServerConfigurationType_TrustList_AddCertificate_InputArguments = init(12613);
    public static final NodeId ServerConfigurationType_TrustList_CloseAndUpdate_InputArguments = init(12706);
    public static final NodeId ServerConfigurationType_TrustList_CloseAndUpdate_OutputArguments = init(12611);
    public static final NodeId ServerConfigurationType_TrustList_Close_InputArguments = init(12595);
    public static final NodeId ServerConfigurationType_TrustList_GetPosition_InputArguments = init(12602);
    public static final NodeId ServerConfigurationType_TrustList_GetPosition_OutputArguments = init(12603);
    public static final NodeId ServerConfigurationType_TrustList_LastUpdateTime = init(12606);
    public static final NodeId ServerConfigurationType_TrustList_OpenCount = init(12590);
    public static final NodeId ServerConfigurationType_TrustList_OpenWithMasks_InputArguments = init(12608);
    public static final NodeId ServerConfigurationType_TrustList_OpenWithMasks_OutputArguments = init(12609);
    public static final NodeId ServerConfigurationType_TrustList_Open_InputArguments = init(12592);
    public static final NodeId ServerConfigurationType_TrustList_Open_OutputArguments = init(12593);
    public static final NodeId ServerConfigurationType_TrustList_Read_InputArguments = init(12597);
    public static final NodeId ServerConfigurationType_TrustList_Read_OutputArguments = init(12598);
    public static final NodeId ServerConfigurationType_TrustList_RemoveCertificate_InputArguments = init(12615);
    public static final NodeId ServerConfigurationType_TrustList_SetPosition_InputArguments = init(12605);
    public static final NodeId ServerConfigurationType_TrustList_Size = init(12587);
    public static final NodeId ServerConfigurationType_TrustList_UserWritable = init(12701);
    public static final NodeId ServerConfigurationType_TrustList_Writable = init(12700);
    public static final NodeId ServerConfigurationType_TrustList_Write_InputArguments = init(12600);
    ...
    public static final NodeId ServerConfiguration_SupportedCertificateTypes = init(12711);
    public static final NodeId ServerConfiguration_SupportedPrivateKeyFormats = init(12639);
    public static final NodeId ServerConfiguration_TrustList_AddCertificate_InputArguments = init(12669);
    public static final NodeId ServerConfiguration_TrustList_CloseAndUpdate_InputArguments = init(12707);
    public static final NodeId ServerConfiguration_TrustList_CloseAndUpdate_OutputArguments = init(12667);
    public static final NodeId ServerConfiguration_TrustList_Close_InputArguments = init(12651);
    public static final NodeId ServerConfiguration_TrustList_GetPosition_InputArguments = init(12658);
    public static final NodeId ServerConfiguration_TrustList_GetPosition_OutputArguments = init(12659);
    public static final NodeId ServerConfiguration_TrustList_LastUpdateTime = init(12662);
    public static final NodeId ServerConfiguration_TrustList_OpenCount = init(12646);
    public static final NodeId ServerConfiguration_TrustList_OpenWithMasks_InputArguments = init(12664);
    public static final NodeId ServerConfiguration_TrustList_OpenWithMasks_OutputArguments = init(12665);
    public static final NodeId ServerConfiguration_TrustList_Open_InputArguments = init(12648);
    public static final NodeId ServerConfiguration_TrustList_Open_OutputArguments = init(12649);
    public static final NodeId ServerConfiguration_TrustList_Read_InputArguments = init(12653);
    public static final NodeId ServerConfiguration_TrustList_Read_OutputArguments = init(12654);
    public static final NodeId ServerConfiguration_TrustList_RemoveCertificate_InputArguments = init(12671);
    public static final NodeId ServerConfiguration_TrustList_SetPosition_InputArguments = init(12661);
    public static final NodeId ServerConfiguration_TrustList_Size = init(12643);
    public static final NodeId ServerConfiguration_TrustList_UserWritable = init(12703);
    public static final NodeId ServerConfiguration_TrustList_Writable = init(12702);
    public static final NodeId ServerConfiguration_TrustList_Write_InputArguments = init(12656);
    public static final NodeId ServerConfiguration_UpdateCertificate_InputArguments = init(12673);
    public static final NodeId ServerConfiguration_UpdateCertificate_OutputArguments = init(12674);
